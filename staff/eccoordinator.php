...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<li><a href="logout.php"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
         ...
         <img class="img-responsive" src="../images/Banner1.jpg" style="width:100%"  height="150px"/>
       
      
<div class="container" align='center'>
  <h2>E.C. Coordinator Portal</h2><br>
  <a href="eccoordinatorclaim.php" class="btn btn-info" role="button">Access Claims</a>
